    ...
    <div className="min-h-screen bg-white text-slate-900">
        ...
        <div className="relative z-10 w-full">
          <div className="max-w-[1200px] mx-auto px-4 pt-28 md:pt-24 pb-16 text-center">
            ...
            <p className="mt-8 text-white/80 text-[16px]">
              ...
              <span className="underline decoration-white/30 underline-offset-2 cursor-default select-none">
                template
              </span>{" "}
              or send a{" "}
              <Link
      ...
      <section className="py-16">
        <div className="max-w-[1200px] mx-auto px-4">
          ...
          {(() => {
            const items = [
              { img: "/services/precision-cutting.png", title: "Precision Cutting", desc: "Laser cutting, waterjet, and CNC routing for sheet materials.", href: "/services/precision-cutting" },
              { img: "/services/cnc-machining.png", title: "CNC Machining", desc: "Multiaxis CNC machining in billet stock.", href: "/services/cnc-machining" },
              { img: "/services/bending.png", title: "Bending", desc: "Bends within 1 degree of accuracy or better.", href: "/services/bending" },
              { img: "/services/countersinking.png", title: "Countersinking", desc: "Allow hardware to sit flush on your parts to reduce wear and tear.", href: "/services/countersinking" },
              { img: "/services/dimple-forming.png", title: "Dimple Forming", desc: "Reinforce and enhance your parts with dimples up to 3\".", href: "/services/dimple-forming" },
              { img: "/services/hardware-insertion.png", title: "Hardware insertion", desc: "Add strong, permanent fasteners to your metal parts.", href: "/services/hardware-insertion" },
              { img: "/services/tapping.png", title: "Tapping", desc: "Easily add threading to allow for the addition of hardware to your parts.", href: "/services/tapping" },
              { img: "/services/anodizing.png", title: "Anodizing", desc: "Increase durability with Class II anodizing services available in 5 colors.", href: "/services/anodizing" },
              { img: "/services/deburring.png", title: "Deburring", desc: "Smooth sharp edges and clean up your metal parts.", href: "/services/deburring" },
              { img: "/services/plating.png", title: "Plating", desc: "Increase rust prevention, wear resistance, and strength with zinc and nickel plating.", href: "/services/plating" },
              { img: "/services/powder-coating.png", title: "Powder Coating", desc: "Give your custom cut parts a bold, long-lasting protective layer in one of 10 options.", href: "/services/powder-coating" },
              { img: "/services/tumbling.png", title: "Tumbling", desc: "Reduce the surface blemishes and handling scratches found in raw materials.", href: "/services/tumbling" },
            ]
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
                {items.map((it) => (
                  <div
                    ...
                    role="button"
                    tabIndex={0}
                    className="rounded-2xl bg-slate-100/70 border border-slate-200 hover:border-slate-300 p-5 transition-shadow hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-black/10 cursor-default"
                    // onClick={() => { /* intentionally disabled */ }}
                    // onKeyDown={(e) => { if (e.key === 'Enter') {/* disabled */} }}
                  >
                    ...
                    <div className="space-y-1">
                      <h3 className="text-[13px] font-extrabold text-slate-800">{it.title}</h3>
                      <p className="text-[12px] leading-snug text-slate-600">{it.desc}</p>
                    </div>

                    {/* tiny arrow label (visual only, not a link) */}
                    <div className="mt-3">
                      <span className="inline-flex items-center text-[12px] font-semibold text-sky-700 select-none">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[1200px] mx-auto px-4 text-center">
          <h2 className="text-[28px] sm:text-[32px] font-extrabold text-slate-900">Trusted by 100,000+ companies</h2>
          <p className="mt-2 text-[16px] text-slate-500">59.8% of companies in the Fortune 500 use SendCutSend</p>
